          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="https://www.instagram.com/the_little_hood.inc" target="_blank" rel="noopener noreferrer" className="text-white/80 text-[14px] font-body hover:text-white transition-colors flex items-center gap-2">
