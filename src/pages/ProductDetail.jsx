      ...
      <section className="max-w-[1280px] mx-auto px-4 md:px-12 py-6 md:py-10">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          ...
          <Motion.div {...fadeUp} className="flex flex-col">
            ...
            {isOutOfStock && (
              <div className="inline-flex items-center self-start mb-4 rounded-full bg-red-50 text-red-700 border border-red-200 px-3 py-1.5 text-[12px] font-semibold uppercase tracking-[0.12em]">
                Out of Stock
              </div>
            )}
            ...
            {isOutOfStock ? (
              <button
                type="button"
                disabled
                className="inline-flex items-center justify-center gap-2.5 w-full md:w-auto px-8 py-3.5 rounded-pill border border-[#d1d5db] bg-[#f3f4f6] text-[#6b7280] font-semibold text-[15px] cursor-not-allowed mb-3"
              >
                Out of Stock
              </button>
            ) : (
